...
import { Shield, Users, Calendar, Edit3, Trash2, Save, X, Plus, ChevronDown, ChevronUp, ArrowLeft, Loader2, Merge, Undo2, AlertTriangle, Check } from 'lucide-react';
...
export const AdminPage: React.FC<Props> = ({ setTab, onExitAdmin }) => {
  ...
  // Tab state
  const [activeSection, setActiveSection] = useState<'players' | 'sessions'>('players');
